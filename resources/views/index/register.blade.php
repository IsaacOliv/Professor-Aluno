...
@section('accountNew')
    <form class="container py-5 h-100" action="{{ route('create') }}" method="post">
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="mb-5">Cadastro professor</h3>

                        <div class="form-outline mb-4">
                            <input name="name" id="typeEmailX-2" class="form-control form-control-lg"
                                placeholder="Nome" />
                        </div>
                        <div class="form-outline mb-4">
